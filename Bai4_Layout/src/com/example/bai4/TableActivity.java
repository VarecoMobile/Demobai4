...
public class TableActivity extends ActionBarActivity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_linear:
			Intent intent2 = new Intent(TableActivity.this,
					LinearActivity.class);
			startActivity(intent2);
			finish();
			break;
		case R.id.menu_relative:
			Intent intent3 = new Intent(TableActivity.this,
					RelativeActivity.class);
			startActivity(intent3);
			finish();
			break;
		case R.id.menu_table:
			Intent intent4 = new Intent(TableActivity.this, TableActivity.class);
			startActivity(intent4);
			finish();
			break;
		case R.id.menu_absolute:
			Intent intent5 = new Intent(TableActivity.this,
